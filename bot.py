...
1. 📊 NOTIFIKASI OTOMATIS (Level Pro)
Bot akan otomatis kirim pesan tanpa diminta:
...
✅ Saat produk expired
2. 💾 DATABASE PERMANEN (Level Expert)
Sekarang data hilang jika bot restart. Kita bisa simpan permanen:
